...
message(STATUS "Updating pip and setuptools...")
execute_process (
	COMMAND bash -c "pip3 install --upgrade setuptools pip"
	RESULT_VARIABLE res
	ERROR_VARIABLE err
)
if(NOT "${res}" STREQUAL "0")
	message(FATAL_ERROR "Pip and setuptools update error: ${err}")
endif()
...
install(PROGRAMS ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_BIN_DIR}/${PROJECT_NAME} DESTINATION /etc/nxs-zabbix/scripts)
